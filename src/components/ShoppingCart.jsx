  ...
  return (
    <div className={`fixed inset-0 z-10 bg-gray-500 bg-opacity-75 transition-opacity ${open ? 'block' : 'hidden'}`}>
      <div className="fixed inset-y-0 right-0 flex max-w-full pl-10">
        <div
          className={`transform transition-transform ease-in-out duration-500 sm:duration-700 ${
            open ? 'translate-x-0' : 'translate-x-full'
          }`}
        >
          <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl max-w-md">
