...
import { useGetBestSellingProductsQuery } from "../services/api";
    ...
    <div className="min-h-screen relative ">
      ...
      <div className="w-full h-32 bg-cover bg-center relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-white text-3xl font-bold">
          Welcome to Our Best Selling Product Page
        </div>
      </div>
      ...
      <div className="flex md:space-x-4 mt-20 justify-center flex-col md:flex-row flex-1">
        ...
        <div className="w-full md:w-3/4">
          ...
          {error ? (
            <div className="text-lg text-center h-screen text-red-400">
